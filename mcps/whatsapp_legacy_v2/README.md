# WhatsApp AI (legacy v2)

Electron app wrapping WhatsApp Web with a built-in MCP server. Superseded by the Beeper-backed WhatsApp MCP in `mcps/whatsapp/`.
...
```bash
cd mcps/whatsapp_legacy_v2 && npm start
```
