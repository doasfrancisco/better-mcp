...
Search defaults:
- Do not override max_results unless the user explicitly asks for more or fewer results.
...
async def gmail_search_messages(
    ...
    Args:
        ...
        max_results: Default 100. Do not override unless the user asks for more or fewer.
